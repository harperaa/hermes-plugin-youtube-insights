...
def _build_produce_brief(script_abs: Path) -> str:
    ...
    return "\n".join([
        ...
        "   mandatory verify_image QA and baseline-reference check). Its",
        "   Absolute Rules apply: never substitute PIL/canvas/ImageMagick or",
        f"   any hand-rolled generator. Save everything under {assets_dir}/",
        "   using the skill's naming convention.",
